...
# Assicurati di aver impostato la variabile d'ambiente GOOGLE_API_KEY o inseriscila qui
...
class FinancialScraperGenerator:
    ...
    def generate_prompt(self, company_name):
        ...
        """
        prompt = f"""
        Scrivi uno script Python completo per eseguire web scraping di dati finanziari per l'azienda {company_name}.
        ...
        2. Lo script deve:
           ...
           - Avere una classe principale chiamata '{company_name.replace(" ", "")}Scraper'
